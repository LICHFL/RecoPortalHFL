...
public class RecoServiceImpl implements RecoService {
	...
	@Override
	public List<BookDto> fetchBookResults(String glCode, String fromDate, String toDate, String catg, String tranTpe)
			throws Exception {

		List<BookDto> resList = customRepo.fetchBookResults(glCode, fromDate, toDate, catg, tranTpe);
		return resList;
