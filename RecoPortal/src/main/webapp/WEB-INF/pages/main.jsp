...
<body>
                            ...
                            <div class="col-sm-12 query-table-loader">
                                <nav>
                                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                        <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Main</a>  <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab"
                                        href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">Freeze</a>
                                        <a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false">Matching</a>
                                    </div>
                                </nav>
                                    ...
                                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                                        <div class="query-table-container pr-0 mb-2">
                                            <form id="searchParametersForm" method="post" action="main">
                                                    ...
                                                    <div class="row" style="margin-top: -30px">
                                                        <div class="col">
                                                            <div class="form-check form-check-inline">
                                                                <input type="radio" class="form-check-input" id="matchingType1" name="matchingType" value="mt1" required>
                                                                <label class="form-check-label" for="matchingType1">Book V/S Bank</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input type="radio" class="form-check-input" id="matchingType2" name="matchingType" value="mt2">
                                                                <label class="form-check-label" for="matchingType2">
                                                                    Bank V/S Book</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input type="radio" class="form-check-input" id="matchingType3" name="matchingType" value="mt3">
                                                                <label class="form-check-label" for="matchingType3">
                                                                    Bank V/S Bank</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input type="radio" class="form-check-input" id="matchingType4" name="matchingType" value="mt4">
                                                ...
                                                <section class="custom-section">
                                                    <label class="section-label">Search <span class="brsParam">Book</span> Parameters
                                                    </label>
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="row mb-2">
                                                                ...
                                                                <div class="col">
                                                                    ...
                                                                    <div class="form-group">
	                                                                    <div class="input-group">
	                                                                        <input type="text" class="form-control form-control-sm date" name="datetimepickerFrom" id="datetimepickerFrom" placeholder="From Date" aria-label="From Date" aria-describedby="datepicker-addon" autocomplete="off">
                                                                ...
                                                                <div class="col">
                                                                    ...
                                                                    <div class="form-group">
	                                                                    <div class="input-group">
	                                                                        <input type="text" class="form-control form-control-sm date" name="datetimepickerTo" id="datetimepickerTo" placeholder="To Date" aria-label="To Date" aria-describedby="datepicker-addon" autocomplete="off">
	                                                                        <div class="input-group-append">
	                                                                            <span class="input-group-text" id="datepicker-addon">
																					<i class="fa fa-calendar"></i>
																				</span>
                                                                ...
                                                                <div class="col">
                                                                    ...
                                                                    <div>
                                                                    	<div class="form-group">
	                                                                        <div class="form-check form-check-inline">
	                                                                            <input type="radio" class="form-check-input" id="tranTypeD" name="tranType" value="debit" required>
	                                                                            <label class="form-check-label" for="tranTypeD">DR</label>
	                                                                        </div>
	                                                                        <div class="form-check form-check-inline">
	                                                                            <input type="radio" class="form-check-input" id="tranTypeC" name="tranType" value="credit">
                                                                ...
                                                                <div class="col">
                                                                    ...
                                                                    <div>
                                                                    	<div class="form-group">
	                                                                        <div class="form-check form-check-inline">
	                                                                            <input type="radio" class="form-check-input" id="des1" name="desc" value="yes">
	                                                                            <label class="form-check-label" for="des1">Yes</label>
	                                                                        </div>
	                                                                        <div class="form-check form-check-inline">
	                                                                            <input type="radio" class="form-check-input" id="des2" name="desc" value="no">
	                                                                            <label class="form-check-label" for="des2">No</label>
	                                                                        </div>
	                                                                     </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col">
                                                                    <div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
                                                                        <button type="button" class="btn btn-primary btn-sm mr-1" id="searhParamBtn">
                                        ...
                                        <section class="custom-section">
                                            ...
                                            <table id="paginationFullNumbers" class="table table-striped table-hover dataTable no-footer table-responsive mt-2" width="100%" style="margin-top: -30px;">
                                                <thead>
                                                    <tr>
    ...
    <!-- Date time picker -->
    <script defer src="resources/vendor/datetimepicker/js/bootstrap-datetimepicker.min.js"></script>
    <!-- Select 2 -->
    ...
    <script defer src="https://cdn.datatables.net/fixedcolumns/4.3.0/js/dataTables.fixedColumns.min.js"></script>
    <!-- Optional JavaScript -->
